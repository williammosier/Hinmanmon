...
class Hinman:
	def __init__(self):
		...
		self.locs = {"hinman college":location.location(pygame.image.load('art/environment/hinman_college.png'),pygame.image.load('art/environment/hinman_college_mask.png').convert_alpha(),pygame.image.load('art/environment/hinman_college_loadzones.png'),'sound/music/death.ogg',-1900,-1200,2600,2600)}
		self.locs["success center"] = location.location(pygame.image.load('art/environment/success_center.png'),pygame.image.load('art/environment/success_center_mask.png').convert_alpha(),pygame.image.load('art/environment/success_center_loadzones.png'),'sound/music/reslife.ogg',0,0,640,480)
		self.locs["hughes"] = location.location(pygame.image.load('art/environment/hughes.png'),pygame.image.load('art/environment/hughes_mask.png').convert_alpha(),pygame.image.load('art/environment/hughes_loadzones.png'),'sound/music/reslife.ogg',0,0,2000,500)
		self.locs["cleveland"] = location.location(pygame.image.load('art/environment/cleveland.png'),pygame.image.load('art/environment/cleveland_mask.png').convert_alpha(),pygame.image.load('art/environment/cleveland_loadzones.png'),'sound/music/reslife.ogg',0,0,2000,500)
		self.locs["lehman"] = location.location(pygame.image.load('art/environment/lehman.png'),pygame.image.load('art/environment/lehman_mask.png').convert_alpha(),pygame.image.load('art/environment/lehman_loadzones.png'),'sound/music/reslife.ogg',0,0,2000,500)
		self.locs["roosevelt"] = location.location(pygame.image.load('art/environment/roosevelt.png'),pygame.image.load('art/environment/roosevelt_mask.png').convert_alpha(),pygame.image.load('art/environment/roosevelt_loadzones.png'),'sound/music/reslife.ogg',0,0,2000,500)
		...
		self.player = player.player(char,WIDTH//2 - 20,HEIGHT//2 - 20)
	...
	def playerInput(self):
		...
		elif keys[pygame.K_b] and self.player.velocity == 15:
